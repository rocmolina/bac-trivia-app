...
const GlobalAppDisabledModal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* z-index muy alto */}
      <div
        className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-md text-center text-gray-800"
        data-oid="vm:u1cr"
      >
        {" "}
        {/* Fondo blanco, texto base oscuro */}
        ...
        <p className="text-gray-600 mb-6 px-4" data-oid=":92p0:2">
          La aplicación está actualmente desactivada por mantenimiento o
          configuración. Intente de nuevo más tarde.
        </p>
        <Button
          onClick={handleAccept}
          className="w-full py-3 text-lg bg-yellow-400 hover:bg-yellow-500 text-black font-semibold"
          /* Botón amarillo, texto negro */ data-oid="sbvhb56"
        >
          Aceptar
        </Button>
      </div>
